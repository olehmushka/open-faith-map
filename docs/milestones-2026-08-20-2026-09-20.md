# Milestones (2026-08-20 – 2026-09-20)

**Archive.** Everything in this file is closed (Stage = built, committed, live-verified) as of
2026-09-20. For anything still open — including M14.18, the U14/U15 unresolved unknowns, and every
milestone from M16 onward — see
[`milestones-2026-09-20-now.md`](milestones-2026-09-20-now.md), the current authoritative file.
...
**U14** and **U15** were still open at the close of this window and are **carried forward, unchanged,
to [`milestones-2026-09-20-now.md`](milestones-2026-09-20-now.md#unresolved-unknowns)** rather than
tracked in two places at once.

| # | The unknown | Where it bites | Who resolves it |
|---|---|---|---|
| ~~**U14**~~ | ~~No apex domain is registered and no DNS-provider API token exists.~~ **Carried forward, still open — see the current file.** | — | — |
| ~~**U15**~~ | ~~Google Drive hotlink reliability at volume is unmeasured.~~ **Carried forward, still open — see the current file.** | — | — |
...
**M14.18 · Deployment wiring is not in this table** — it was still `🔶` (blocked on U14) at the
close of this window and is carried forward, unchanged, as the one open row in
[`milestones-2026-09-20-now.md`](milestones-2026-09-20-now.md#stage-board).
...
**Moved to the current file.** M14.18 was still `🔶` (blocked on U14) at the close of this
window — since it is not closed, its full detail now lives in
[`milestones-2026-09-20-now.md`](milestones-2026-09-20-now.md#m1418--deployment-wiring) rather
