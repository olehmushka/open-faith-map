...
// last row in the previous page (M7, docs/modules/hardening.md). Domain knows only the decoded
// fields (domain.PageCursor); base64/JSON encoding is a transport-only concern.
...
// reinterpreted as "start from page 1" (hardening.md's invariant).
